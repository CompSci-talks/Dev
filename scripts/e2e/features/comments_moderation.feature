Feature: Comments & Moderation
  ...
  Background:
    Given I am on a seminar detail page for "Quantum Computing 101"
  ...
  Scenario: Admin moderates a comment
    Given the comment "This is a great seminar topic!" exists
    When I log in as an administrator
    And I navigate to the moderation view for "Quantum Computing 101"
    And I delete the comment "This is a great seminar topic!"
    Then the comment "This is a great seminar topic!" should no longer be visible for any user
